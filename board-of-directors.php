...
<head>
  ...
  <title>PKPP Agro - Lembaga Pengarah</title>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="member-info">
                <h4>Puan Sarwah binti Mohamed Jusoh</h4>
                <span>Pengarah</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="assets/img/bod_image/roslan.jpg" class="img-fluid" alt="">
              </div>
              <div class="member-info">
                <h4>Tuan Haji Roslan bin Mohd. Ali</h4>
                <span>Pengarah</span>
              </div>
            </div>
          </div>
