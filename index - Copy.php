...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">PKPP Agro</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#abut">Aktiviti Kami</a></li>
          <li><a class="nav-link scrollto" href="#services">Iklan / Program</a></li>
          <li><a class="nav-link scrollto " href="#portfolio">Pautan</a></li>
          <li><a class="nav-link scrollto" href="#pricing">Kelestarian & Integriti</a></li>
